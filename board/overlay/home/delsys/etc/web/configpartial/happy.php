...
<div class="jumbotron text-xs-center" style="background-color: #fff;">
  ...
  <br>
  <img src="images/happy.png" style="height: 140px; width: 140px; margin-left: 200px;"><br>
 ...
 <button type="submit" class="btn btn-primary btn-sm" style="margin: auto;display: block;"  ><span class="glyphicon glyphicon-circle-arrow-left" style="background-color: #1e90ff;"></span>  Back to homepage</button>
</form> 
  </p>
</div>
</div>
